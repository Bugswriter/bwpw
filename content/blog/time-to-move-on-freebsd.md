...
## What is FreeBSD? {#what-is-freebsd}
...
{{< figure src="/images/freebsd-devil.jpg" caption="Figure 1: FreeBSD Devil" >}}


## Why FreeBSD over GNU/Linux? {#why-freebsd-over-gnu-linux}
...
{{< figure src="/images/freebsd-watch.jpg" caption="Figure 2: What time it is? Its time for FreeBSD" >}}


## Why not OpenBSD or NetBSD? {#why-not-openbsd-or-netbsd}
...
## Issues I am expecting {#issues-i-am-expecting}
